          ...
          <Button 
            ...
            onClick={() => {
              ...
              if (!trimmedEmail && !trimmedPhone) {
                setError('Ajoutez un email ou un numéro de téléphone comme identifiant.');
                return;
              }
              ...
              setError('');
              onSave(trimmedName, trimmedEmail, role, trimmedPhone || undefined, trimmedPassword || undefined);
            }}
          >
            Ajouter
          </Button>
